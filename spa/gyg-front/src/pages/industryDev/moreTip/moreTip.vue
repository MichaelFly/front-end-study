    ...
    <div class="breadWrap">
      <div class="breadContent clearfix">
        ...
        <el-breadcrumb class="breadRight" separator-class="el-icon-arrow-right">
          ...
          <el-breadcrumb-item>申报提示</el-breadcrumb-item>
        </el-breadcrumb>
      </div>
    </div>
    <div class="mainWrap">
      <div class="filterWrap">
        <span class="title">申报提示列表</span>
        <label>类型：</label>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      rowClick(id){
        let vm = this;
        window.open(this.$router.resolve({path: "/industryDev/moreTip/detail",query: {tipId: id}}).href, '_blank');
        // vm.$router.push({path: "/industryDev/moreTip/detail",query: {tipId: id}})
      },
