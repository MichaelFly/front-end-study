    ...
    <div class="breadWrap">
      <div class="breadContent clearfix">
        ...
        <el-breadcrumb class="breadRight" separator-class="el-icon-arrow-right">
          ...
          <el-breadcrumb-item>创新引导</el-breadcrumb-item>
        </el-breadcrumb>
      </div>
    </div>
    <div class="mainWrap">
      <div class="filterWrap">
        <span class="title">创新引导</span>
        <label>类型：</label>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      rowClick(id){
        let vm = this;
        window.open(this.$router.resolve({path: "/industryDev/moreGuide/detail",query: {guideId: id}}).href, '_blank');
        // vm.$router.push({path: "/industryDev/moreGuide/detail",query: {guideId: id}})
      },
