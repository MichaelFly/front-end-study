    ...
    <div class="breadWrap">
      <div class="breadContent clearfix">
        ...
        <el-breadcrumb class="breadRight" separator-class="el-icon-arrow-right">
          ...
          <el-breadcrumb-item>厂房租售</el-breadcrumb-item>
        </el-breadcrumb>
      </div>
    </div>
    <div class="mainWrap">
      <div class="filterWrap">
        <span class="title" style="font-weight: bold">厂房租售列表</span>
        <label>类型：</label>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      rowClick(id){
        let vm = this;
        window.open(this.$router.resolve({path: "/companyRes/factoryDetails",query: {id: id}}).href, '_blank');
        // vm.$router.push({path: "/companyRes/factoryDetails",query: {id: id}})
      },
